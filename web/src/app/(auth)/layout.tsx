    ...
    <div className="grid min-h-dvh bg-cream-50 lg:grid-cols-[minmax(360px,.82fr)_minmax(560px,1.18fr)]">
      <aside className="relative hidden min-h-dvh overflow-hidden bg-ink-900 p-10 text-white lg:flex lg:flex-col lg:justify-between xl:p-14">
        ...
        <div className="relative flex items-center gap-3">
          <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-white text-ink-900"><OhFomeMark className="h-9 w-9" /></span>
          <span><strong className="block font-display text-xl tracking-[-.04em]">OhFome</strong><small className="text-[10px] uppercase tracking-[.18em] text-white/45">Gestão para quem faz</small></span>
        </div>
      ...
      <main className="relative flex min-h-dvh items-center justify-center overflow-hidden px-4 py-8 sm:px-8 lg:px-12">
        ...
        <div className="relative w-full max-w-2xl">
          <div className="mb-8 flex items-center justify-center gap-3 lg:hidden">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-ink-900 text-cream-50"><OhFomeMark className="h-8 w-8" /></span>
            <span className="font-display text-xl font-bold tracking-[-.04em]">OhFome</span>
          </div>
