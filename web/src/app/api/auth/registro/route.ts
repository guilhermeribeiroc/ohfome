...
export async function POST(request: NextRequest) {
  ...
  if (!planoParaModulos(modulos)) return NextResponse.json({ erro: "Selecione uma combinação válida: Central de pedidos é obrigatória e Cozinha exige Garçom." }, { status: 400 });
